<#
.SYNOPSIS
Get-Log-MD_Large_Keys_Daily_Task.ps1 creates a daily task to run LOG-MD Large Registy Keys feature.
  - Runs LOG-MD -rs 20 -o $ARTHIR_OutputDir
...
$TaskName = "Test_LOG-MD-Large-Keys"
# Description of the scheduled task
$TaskDescr = "Create a LOG-MD Daily Check for Large Registry Keys Task"
...
$TaskArg = "-rs $KeySize"
# Size of the key you want to hunt for
$KeySize = 20
...
#
# Create Schedule Task to run Large Registry Keys
#
