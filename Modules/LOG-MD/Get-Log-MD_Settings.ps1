<#
.SYNOPSIS
Get-LOG-MD_Settings.ps1 returns output of the LOG-MD configurations from:
 - Whitelists_<all of them>.txt
 - Settings_PowerShell.txt

This will help you assess the configurartion LOG-MD is using and if there are any issues
with your settings or whitelists.
...
DOWNLOAD C:\Program Files\LMD\Results\*Report_Configuration*
#>
$Tool_Name = "LOG-MD.exe"
$ARTHIR_Dir = "C:\Program Files\LMD"
$ARTHIR_OutputDir = "C:\Program Files\LMD\Results"
$ARTHIR_ReportName = "Report_Configuration.txt"
$RenameReports = "Yes"
...
if (Test-Path $ARTHIR_Dir\$Tool_Name) {
    ...
    & $ARTHIR_Dir\$Tool_Name -c > $ARTHIR_OutputDir\$ARTHIR_ReportName 
} else {
