<#
.SYNOPSIS
Get-DNS-Cache.ps1 - This will collect the DNS Cache.
 - Looks for 
...
DOWNLOAD C:\Program Files\ARTHIR\*Report_DNS-Cache.txt
#>
$ARTHIR_OutputDir = "C:\Program Files\ARTHIR"
$ARTHIR_ReportName = "Report_DNS-Cache.txt"
...
invoke-command {
 IPConfig /DisplayDNS | where {$_ -AND $_ -notmatch "command completed successfully"} |
